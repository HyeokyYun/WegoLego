  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: SvgPicture.asset("assets/app_bar/appBar.svg", height: 27.h, width: 86.w,),
        centerTitle: false,
        elevation: 0.0,
        backgroundColor: Colors.white,
      ),
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  textWidget("도움으로 세상을 밝혀준 랭킹",AppTextStyle.koBody2.copyWith(color: AppColors.grey)),
                  sizedBoxWidget(74, 0)
                ],
              ),
              sizedBoxWidget(0, 16),
              Container(width: 340.w, height: 600.h,
                child:
                    dropdown
                        ? StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Container(height: 200.h,
                                child: Column(
                                  children: [
                                    Expanded(child: ListView(children: documents.map((doc) => _buildItemWidget(doc)).toList())),
                                  ],
                                ),
                              );
                            })
...
Widget _buildItemWidget(DocumentSnapshot doc) {
  ...
  return ListTile(
      title: Container(height: 60.h, width: 325.w,
      child: Card(
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            Container(width: 200.w, height:34.h ,
              child: Row(children: [
                sizedBoxWidget(10, 0),
                ClipRRect(
                ...
                Container(
                  width: 140.w,
                  child: textWidget(rank.name, AppTextStyle.koBody2.copyWith(fontSize: 14.sp,height: 1.2.h),
                  ),
                ),
              ]),
            ),
