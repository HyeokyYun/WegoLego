...
class PieChart extends CustomPainter {
  ...
  PieChart({required this.percentage, this.location, required this.getcolor});

  @override
  void paint(Canvas canvas, Size size) {
    Paint paint = Paint()
      ..color = Colors.black.withOpacity(0.0) // 화면에 그릴 때 쓸 Paint를 정의합니다.
      ..strokeWidth = 7.0 // 선의 길이를 정합니다.
      ..style =
    ...
    double arcAngle =
        2 * pi * (percentage / 40); // 호(arc)의 각도를 정함. 정해진 각도만큼만 그리도록 함.

    paint.color = getcolor; // 호를 그릴 때는 색을 바꿔줌.
